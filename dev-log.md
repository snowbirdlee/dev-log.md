...
# INTRO TO LLM'S; creating the Base Model
...
- there are ***parameters weights*** (usually billions 😱) that make this possible. 
...
- ***inference token***s: infer the next word (using tokens). exercising the model by running it.
